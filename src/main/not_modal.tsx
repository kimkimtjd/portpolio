...
function NotModal({ onClose }: NotModalProps) {
    const first_option: FirstOption[] = [
        { title: "틀린 답변을 제공함", trual: false },
        { title: "최신 법률 정보가 반영되지 않음", trual: false },
        { title: "잘못된 법률 정보를 인용함", trual: false },
        { title: "도움이 되지 않거나 관련성 없는 답변", trual: false },
        { title: "지시한 내용을 다 따르지 않음", trual: false },
        { title: "질의에 충실하지 않은 부실한 답변", trual: false },
        { title: "오류로 인한 답변 미생성", trual: false },
    ...
    return (
        <FlexColumnCenterStart style={{ padding: "30px 20px" }}>
            <h3 style={{ fontSize: "32px" }}>어떤 점이 아쉬웠나요?</h3>
